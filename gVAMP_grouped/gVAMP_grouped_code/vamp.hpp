...
private:
    int N, M, Mt, K, C, max_iter, rank, nranks;
...
public:
    ...
    //  CONSTRUCTORS 
    //******************
    vamp(int N, int M,  int Mt, double gam1, double gamw, int max_iter, double rho, std::vector<std::vector<double>> vars,  std::vector<std::vector<double>> probs, std::vector<double> true_signal, int rank, std::string out_dir, std::string out_name, std::string model, Options opt = Options());
    ...
    //********************************************
    double g1(double x, double gam1, int idx);
    double g1_bin_class(double p, double tau1, double y, double m_cov);
    double g1d(double x, double gam1, int idx);
