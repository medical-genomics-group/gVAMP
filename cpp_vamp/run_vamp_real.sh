...
#SBATCH --output=vamp_height_rho09_gamwL_PL_truesignalOn_testset_it30_CG10_07102022.log
...
time mpirun -np 5 ./main_real.exe --bed-file --bed-file /nfs/scistore13/robingrp/human_data/geno/ldp08/ukb22828_UKB_EST_v3_ldp005_maf01.bed \
                                ...
                                --out-name x1_hat_height_gamwL_CG_10_PL_rho_08_13_9_22 \
                                --iterations 12 \
                                --num-mix-comp 3 \
                                --CG-max-iter 10 \
                                --model linear \
