...
int main()
{
    ...
    std::string loc_beta_true = "/nfs/scistore13/robingrp/human_data/adepope_preprocessing/VAMPJune2022/cpp_VAMP/M_115233_N_8430446_beta_true.txt";
    if (rank == 0){
    ...
    //std::cout << "rank = " << rank << ", before initializing dataset object" << std::endl;
    ...
    if (rank==0)
        std::cout << "rank = " << rank << ", after read_genotype_data" << std::endl;
    ...
    std::string out_name = "x1_hat_height_main_corr_big"; 
