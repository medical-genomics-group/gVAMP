...
#SBATCH --mem 8gb
#SBATCH --time 0-00:28:00
#SBATCH --output=/nfs/scistore13/robingrp/adepope/PhD/gene2/geneAMP/Height_uncorr_005_new.log
...
module list
 ...
 srun $program_location \
    --bfile $wd/ukb_imp_v3_UKB_EST_uncorrpeople_pruned_005_ready \
    --pheno $wd/ukb_imp_v3_UKB_EST_uncorrpeople_pruned_005_ready.fam \
    --failure $wd/ukb_imp_v3_UKB_EST_uncorrpeople_pruned_005_ready.fam \
    --mpibayes geneAMPMPI \
    --chain-length 5  \
    --burn-in 0 \
    --thin 5 \
